...
import re
import importlib
import modules.AlitaGeneralTools.AlitaGeneralTools


def convert(name, text):
    text = modules.AlitaGeneralTools.AlitaGeneralTools.double_spaces_to_single_space(text)
    text = modules.AlitaGeneralTools.AlitaGeneralTools.remove_starting_space(text)
...
modules_list = {"modules.AlitaGeneralTools.AlitaGeneralTools"}
